...
class Constants(object):
    APIS = {
        ...
        'OPEN-FINANCE': {
            'URL': {
                'production': 'https://openfinance.api.efipay.com.br/open-finance',
                'sandbox': 'https://openfinance-h.api.efipay.com.br/open-finance'
            },
            'ENDPOINTS': {
                'authorize': {
                    'route': '/oauth/token',
        ...
        'PAGAMENTOS': {
            'URL': {
                'production': 'https://abrircontas.api.efipay.com.br/pagamento',
                'sandbox': 'https://abrircontas-h.api.efipay.com.br/pagamento'
            },
            'ENDPOINTS':{
                'authorize': {
                    'route': '/oauth/token',
